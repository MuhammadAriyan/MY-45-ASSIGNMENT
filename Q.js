...
//SECOND QUESTION 
var personal_msg = 'Hello Eric, would you l;ike to learn some python today?';
console.log(personal_msg);
//THIRD QUESTION
var person_name = "monkey d luffy";
var lower = person_name.toLowerCase();
var capital = person_name.toUpperCase();
var title = person_name.toLowerCase().replace(/\b\w/g, function (char) { return char.toUpperCase(); });
console.log(lower);
console.log(capital);
console.log(title);
//QUESTION NO. 4
var quote = "MONKEY D LUFFY ONCE SAID, \"IF YOU DONT TAKE RISKS, YOU CAN'T T CREATE A FUTURE\"";
console.log(quote);
//question no. 5
//this program prints a quote
var famous_person = "RORONOA ZORO";
var quotee = "".concat(famous_person, " ONCE SAID, \"ONLY I CAN CALL MY DREAM STUPID!\" ");
console.log(quotee);
//question no.6
